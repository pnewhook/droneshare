...
(function () {
    ...
    module.exports = function (grunt) {
        ...
        grunt.registerTask('prod', ['clean:working', 'coffeelint', 'copy:app', 'ngTemplateCache', 'shimmer:prod', 'coffee:app', 'less', 'requirejs', 'uglify', 'hash:scripts', 'hash:styles', 'template:index', 'minifyHtml', 'copy:prod']);
